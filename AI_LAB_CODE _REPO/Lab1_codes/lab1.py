...
# Heuristic 0: Null heuristic, returns 0 for any state (Uniform Cost Search)
...
# Heuristic 2: Manhattan distance, sum of horizontal and vertical distances of all marbles from the center
...
# Depth, Time Taken, and Memory analysis
